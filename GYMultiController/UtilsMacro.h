...
#define kDefaultAppKey @"ronghui1lian#ronghui"
#define kDefaultCustomerName @"ronghuikefu"
#define kAppKey @"ronghui1lian#ronghui"
#define kCustomerName @"ronghuikefu"
#define kCustomerNickname @"榕儿"
